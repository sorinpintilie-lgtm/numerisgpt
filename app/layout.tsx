...
export const metadata: Metadata = {
  title: "Numeris | Tehnologie Medicală",
  description: "Echipamente medicale premium",
};
      ...
      <body className={`${inter.className} bg-slate-50 text-slate-800 antialiased`}>
        ...
        <div className="promo-bar">
          <div className="promo-desktop">
            <span>
              Concept demo - Continut orientativ - Dezvoltat de sky.ro - 
              <a href="mailto:dan.trifan@sky.ro"> dan.trifan@sky.ro</a> - 
              <a href="tel:+40720088880"> +4 0720 088 880</a>
            </span>
            <a className="btn-promo" href="https://wa.me/40720088880" target="_blank" rel="noopener noreferrer">
              WhatsApp
            </a>
          </div>
          <div className="promo-mobile">
            <div className="promo-seg-left">Concept demo</div>
            <div className="promo-seg-center">Dezvoltat de sky.ro</div>
            <div className="promo-seg-right">
              <a href="tel:+40720088880">+4 0720 088 880</a>
            </div>
          </div>
        </div>
